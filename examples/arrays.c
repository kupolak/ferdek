...
int main() {
    print_value(make_string("=== Test Tablic ==="));
    FerdekValue liczby = make_array((FerdekValue[]){make_int(10), make_int(20), make_int(30), make_int(40), make_int(50)}, 5);
    print_value(make_string("Tablica:"));
    print_value(liczby);
    print_value(make_string("Pierwszy element:"));
    FerdekValue pierwszy = make_int(0);
    pierwszy = array_get(liczby, to_int(make_int(0)));
    print_value(pierwszy);
    print_value(make_string("Trzeci element:"));
    FerdekValue trzeci = make_int(0);
    trzeci = array_get(liczby, to_int(make_int(2)));
    print_value(trzeci);
    return 0;
}
