...
FerdekValue dodaj(FerdekValue a, FerdekValue b);
FerdekValue powitanie();



FerdekValue dodaj(FerdekValue a, FerdekValue b) {
    FerdekValue wynik = make_int(0);
    wynik = make_int(to_int(a) + to_int(b));
    return wynik;
}

FerdekValue powitanie() {
    print_value(make_string("Cze\197\155\196\135 z funkcji!"));
    return make_null();
}
...
int main() {
    print_value(make_string("=== Test Funkcji ==="));
    FerdekValue suma = make_int(0);
    suma = dodaj(make_int(5), make_int(3));
    print_value(make_string("5 + 3 ="));
    print_value(suma);
    powitanie();
    return 0;
}
